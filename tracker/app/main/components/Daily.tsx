...
interface IDailyInnerProps extends IDailyProps {
  classes: ReturnType<typeof useStyles>['classes'];
}

class DailyInner extends React.Component<IDailyInnerProps, IDailyState> {
  constructor(props: IDailyInnerProps) {
    super(props);
...
function DailyWrapper(props: IDailyProps) {
  ...
  return <DailyInner {...props} classes={classes} />;
}
