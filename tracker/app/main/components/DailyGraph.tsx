...
const useStyles = makeStyles()((_theme: Theme) => ({
  ...
  chartContainer: {
    ...
    '& .google-visualization-tooltip table tr:nth-of-type(odd)': {
      backgroundColor: '#ddd',
    },
    '& .google-visualization-tooltip table td:first-of-type': {
      textAlign: 'right',
    },
...
interface IDailyGraphInnerProps extends IDailyGraphProps {
...
function DailyGraphWrapper(props: IDailyGraphProps) {
  const { classes } = useStyles();
  return <DailyGraphInner {...props} classes={classes} />;
}
