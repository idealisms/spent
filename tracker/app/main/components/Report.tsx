...
interface IReportInnerProps extends IReportProps {
  classes: ReturnType<typeof useStyles>['classes'];
}

class ReportInner extends React.Component<IReportInnerProps, IReportState> {
  /** LRU cache of report data. Old items are at the front of the Array. */
  private reportDataCache: Array<ReportData>;

  constructor(props: IReportInnerProps) {
    super(props);
    ...
    return (
      <div className={classes.root}>
        ...
        <div className={classes.contentAndDrawerContainer}>
          ...
          {/* Mobile drawer - hidden on sm and up */}
...
function ReportWrapper(props: IReportProps) {
  const { classes } = useStyles();
  return <ReportInner {...props} classes={classes} />;
}
