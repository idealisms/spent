...
interface IReportChartInnerProps extends IReportChartProps {
  classes: ReturnType<typeof useStyles>['classes'];
}

class ReportChartInner extends React.PureComponent<
...
> {
  ...
  constructor(props: IReportChartInnerProps) {
    super(props);
    this.state = {};
...
function ReportChartWrapper(props: IReportChartProps) {
  const { classes } = useStyles();
  return <ReportChartInner {...props} classes={classes} />;
}
