...
const qualifiedDividendLookup: Record<string, number> = {
  ...
  // Schwab funds
  SWPPX: 1.0, // Schwab S&P 500 Index — all domestic large cap

  // Vanguard bond / money market — interest income, never qualified
  BND: 0.0, // Vanguard Total Bond Market ETF
  VBTLX: 0.0, // Vanguard Total Bond Market Index Admiral
  VMFXX: 0.0, // Vanguard Federal Money Market Fund

  // Vanguard domestic equity — highly qualified
  VLGSX: 0.99, // Vanguard Large-Cap Index Admiral
  VOO: 1.0, // Vanguard S&P 500 ETF
