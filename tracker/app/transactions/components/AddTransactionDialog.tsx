...
interface IAddTransactionDialogInnerProps extends IAddTransactionDialogProps {
  classes: ReturnType<typeof useStyles>['classes'];
}

class AddTransactionDialogInner extends React.Component<
  IAddTransactionDialogInnerProps,
  IAddTransactionDialogState
> {
  constructor(props: IAddTransactionDialogInnerProps) {
    super(props);
    this.state = {
...
function AddTransactionDialogWrapper(props: IAddTransactionDialogProps) {
  const { classes } = useStyles();
  return <AddTransactionDialogInner {...props} classes={classes} />;
}

export default AddTransactionDialogWrapper;
